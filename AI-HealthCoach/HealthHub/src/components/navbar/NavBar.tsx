...
export function NavBar() {
    ...
    onClick={() => window.location.href = "http://localhost:5173/survey"}
>
                        Get Started
                    </button>
                </div>
                <div
                    ...
                    id="navbar-sticky"
                >
                    <ul className="flex flex-col-4 p-4 lg:p-0 mt-4 font-medium rounded-lg lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 bg-transparent">
                        <li>
                            <a
                                href="#"
