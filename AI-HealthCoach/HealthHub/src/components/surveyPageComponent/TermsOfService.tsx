            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
                <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="text-sm text-black space-y-4 mb-6">
                        <p><strong>Not a Diagnosis:</strong> AI-HealthCoach for your healthylife style tracking.</p>
                        ...
                        <p><strong>HealthCare Advice:</strong> Consult your doubts and clarificaton to maintain a heathy life style</p>
                    </div>
