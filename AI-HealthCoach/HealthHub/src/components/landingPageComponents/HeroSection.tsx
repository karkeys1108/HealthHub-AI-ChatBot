            ...
            <div className="heroSectionContent">
                            ...
                            <span className="leftSectionTitle">
                                ...
                                <span className="leftSectionSecondLine">
                                    ...
                                    {isLargeScreen ? (
                                        ...
                                        <span className="staticText">HealthyLifeStyle</span>
                                    )}
                                </span>
                            </span>
                        </BlurFade>
                ...
                <div className="heroSectionRightPart">
                    <BlurFade delay={1} duration={0.8} inView>
                        <div>
                            <h3 className="h3">
                            Welcome to your AI Health Coach! Here to empower you with personalized guidance and support on your journey to a healthier lifestyle,
                             while tracking your daily health details to help you stay on course.
                            </h3>
                        </div>
                    </BlurFade>
                    <BlurFade delay={2} duration={0.4} inView>
                        <div className="buttonContainer">
                            ...
                            <ButtonComponent transparent={true} onClick="">
                                Learn More
                            </ButtonComponent>
                        </div>
                    </BlurFade>
